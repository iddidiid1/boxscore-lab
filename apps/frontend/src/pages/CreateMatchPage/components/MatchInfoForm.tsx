...
export function MatchInfoForm(props: Props) {
  ...
  return <Box className="match-form-section app-surface app-surface--editor"><Title order={2}>Match Information</Title><SimpleGrid cols={{ base: 1, sm: 2, lg: 3 }} spacing="md">
